...
local terminal_extra    = "terminator"
...
local myawesomemenu = {
    ...
    ---{ "edit config", "vim ~/.config/awesome/rc.lua" },
    ---{ "arandr", "arandr" },
...
root.buttons(my_table.join(
    ...
    awful.button({ }, 3, function () if connect then end end),
...
globalkeys = my_table.join(
    ...
    -- screenshots
    awful.key({modkey1}, "Print", function () awful.util.spawn("scrot 'ArcoLinuxD-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir PICTURES)'") end,
    ...
    -- Personal keybindings}}}
    awful.key({modkey,},"XF86Explorer", function () os.execute("slock") end,
        {description = "lock screen", group = "tag"}),
    awful.key({modkey,},"t", function () os.execute("slock") end,
        {description = "lock screen", group = "tag"}),
    awful.key({modkey, "Shift"},"t", function () os.execute("i3lock -c de8e33 -i ~/.config/wallpaper.png") end,
        {description = "lock screen", group = "tag"}),
    awful.key({modkey,"Shift"},"o", function() screen.primary:swap(screen[1]) end,
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    awful.key({ modkey, "Control" }, "Return", function () awful.spawn( terminal_extra.." -e fish" ) end,
              {description = "terminal with fish shell", group = "super"}),
...
awful.rules.rules = {
    ...
    { rule = { instance = "Xfce4-screenshooter" },
